      ...
      <div className="max-w-md mx-auto animate-in fade-in duration-500">
        <Card className="shadow-card overflow-hidden">
          ...
          <CardHeader className="text-center pt-8">
            <div className="mx-auto w-20 h-20 rounded-2xl bg-amber-500/10 flex items-center justify-center mb-4">
              <AlertCircle className="h-10 w-10 text-amber-500" />
            </div>
            <CardTitle className="text-2xl">Sudah Absen Hari Ini</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          {step === 'camera' && (
            <div className="space-y-4">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-muted" style={{ aspectRatio: '3/4' }}>
                {!photo ? (
                  <video
                    ref={videoRef}
                    autoPlay
                ...
                {/* Overlay guides - larger oval for face */}
